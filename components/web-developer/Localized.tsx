  ...
  return (
    <section className="py-20 px-6 bg-zinc-950/50">
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="bg-zinc-900 border border-white/10 p-8 rounded-2xl relative">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-3 bg-white/5 rounded-lg border border-white/10 text-center cursor-pointer">
